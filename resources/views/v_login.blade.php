    ...
    <div class="auth-content">
        <div class="card">
            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        <img src="{{ asset('template') }}/dist/assets/images/banksampah.png" alt=""
                            style="width:60px" class="img-fluid mb-4">
                        <h6>Sistem Informasi Bank Sampah</h6>
                        <br>
                        ...
                        <form class="form" action="{{ route('login.check') }}" method="POST">
                            ...
                            <form>
                                {{-- <p class="mb-2 text-muted">Lupa Password? </p> --}}
...
<div class="fixed-button active"><a href="/" class="btn btn-md btn-warning"><i class="fa fa-home"
            aria-hidden="true"></i> Kembali ke Home</a> </div>
<!-- [ auth-signin ] end -->
