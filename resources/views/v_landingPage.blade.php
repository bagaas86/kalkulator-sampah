...
<body>
        ...
        <div class="navbar-wrapper container">
            <div class="navbar-content sidenav-horizontal" id="layout-sidenav">
                <ul class="nav pcoded-inner-navbar sidenav-inner">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('auth') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-log-in"></i></span><span class="pcoded-mtext">LOGIN</span></a>
                    </li>
        ...
        <div class="container">
            <div class="m-header">
                ...
                <a href="#!" class="b-brand">
                    ...
                    <img src="{{ asset('template') }}/dist/assets/images/banksampah.png" style="width:50px"
                        alt="" class="logo">
    ...
    <div class="pcoded-main-container" style="background-color: white">
        <div class="pcoded-wrapper container text-center">
            <h2>BANK SAMPAH</h2>
            <img src="{{ asset('template') }}/dist/assets/images/banksampah.png" style="width:40%" alt=""
                class="logo">
        </div>


        <div class="pcoded-wrapper container text-center mt-4">
            <h2>SAMPAH TERSEDIA</h2>
        </div>
                        ...
                        <center>
                            <div class="col col-md-6 mt-4">
                                <h6 style="color:white">
                                    <a href="https://wa.me/+6282249025414/?text=Hello%20there!" target="_blank"
                                        style="color: white">Hubungi</a>
                                </h6>
                                <h6 style="color:white">
                                    Copyright © 2023 Bagas. All rights reserved.
                                </h6>
                            </div>
                        </center>
                    </div>
